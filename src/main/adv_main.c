...
static int adv_init(int argc,char **argv) {
  ...
  if ((err=adv_input_map_useraction(0x013a,ADV_USERACTION_QUIT))<0) return err; // 8bitdo SNES Select
  if ((err=adv_input_map_useraction(0x013c,ADV_USERACTION_QUIT))<0) return err; // Evercade Heart
